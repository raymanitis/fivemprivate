-- ---@diagnostic disable
-- -- Converted to qbox/standalone; ESX dependency removed

-- local Mod = require 'towing/config'
...
-- local function GetNearestPlayerCoordsToEntity(entity)
--     local entityCoords = GetEntityCoords(entity)
--     local players = GetActivePlayers()
--     local closestCoords = entityCoords
--     local closestDist = 1e9
--     for _, player in ipairs(players) do
--         local ped = GetPlayerPed(player)
--         if DoesEntityExist(ped) then
--             local coords = GetEntityCoords(ped)
--             local dist = GetDistanceBetweenCoords(entityCoords, coords, true)
...
-- -- Command disabled; towing via rope item only

-- -- Removed NUI/menu; interactions via ox_target only
...
--                             local pos = GetNearestPlayerCoordsToEntity(rope['veh2'])
...
--                 local pos = GetNearestPlayerCoordsToEntity(driverPed)
...
--                 if veh1 ~= 0 then SetEntityMaxSpeed(veh1, 99999.0) end
--                 if veh2 ~= 0 then SetEntityMaxSpeed(veh2, 99999.0) end
--             end
--         end
--     end
-- end)
...
--         return -- ox_target not present
--     end

--     local function doMechanicProgress(label)
--         local opts = {
--             duration = 5000,
--             label = label,
--             useWhileDead = false,
...
--         }
--         local anim = Config.mechanicAnim
...
--             and IsEntityAVehicle(entity)
--             and not Contains(Config.blacklistedClasses, GetVehicleClass(entity))
--             and (not Config.checkForLocks or (function()
--                 local lock = GetVehicleDoorLockStatus(entity)
--                 return (lock == 0 or lock == 1 or lock == 7 or lock == 8)
--             end)())
--     end

--     local function playerHasRope()
--         local ok, count = pcall(function()
--             return exports.ox_inventory:Search('count', Config.towRopeItem)
--         end)
...
--         {
--             name = 'atleast_towing_connect_front',
--             icon = 'fa-solid fa-link',
--             label = 'Tow: Connect as Front',
--             onSelect = function(data)
--                 local veh = data.entity
--                 if veh and veh ~= 0 and veh ~= entity2 and canAttach(veh) then
--                     if not doMechanicProgress('Attaching rope (front)...') then return end
--                     entity1 = veh
...
--                     AttemptAttachRope()
--                 else
--                     ShowTooltip(Locale.vehicles_locked or 'Vehicle locked or invalid')
--                 end
--             end,
--             canInteract = function(entity, distance, coords, name)
--                 return distance <= 3.0 and canAttach(entity) and entity ~= entity2 and playerHasRope()
--             end
--         },
--         {
--             name = 'atleast_towing_connect_rear',
--             icon = 'fa-solid fa-link',
--             label = 'Tow: Connect as Rear',
--             onSelect = function(data)
--                 local veh = data.entity
--                 if veh and veh ~= 0 and veh ~= entity1 and canAttach(veh) then
--                     if not doMechanicProgress('Attaching rope (rear)...') then return end
--                     entity2 = veh
--                     if (entity1 == nil or entity2 == nil) then
...
--             end,
--             canInteract = function(entity, distance, coords, name)
--                 return distance <= 3.0 and canAttach(entity) and entity ~= entity1 and playerHasRope()
--             end
--         },
--         {
--             name = 'atleast_towing_detach',
--             icon = 'fa-solid fa-xmark',
--             label = 'Tow: Detach Rope',
--             onSelect = function(data)
--                 if not doMechanicProgress('Detaching rope...') then return end
--                 DetachRope()
--             end,
--             canInteract = function(entity, distance, coords, name)
--                 return distance <= 3.0 and (entity1 ~= nil or entity2 ~= nil or localRope ~= nil or tempRope ~= nil)
--             end
--         }
--     })
-- end)
