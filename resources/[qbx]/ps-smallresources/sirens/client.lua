-- local config = require 'sirens/config'
...
--             if sirenConfig.horn.audioName then audioName = sirenConfig.horn.audioName end
--             if sirenConfig.horn.audioRef then audioRef = sirenConfig.horn.audioRef end
...
--     if not config.disableDamagedSirens and ((config.useEngineHealth and GetVehicleEngineHealth(veh)) or GetVehicleBodyHealth(veh)) <= config.damageThreshold then
...
--                 local modeCfg = sirenConfig.sirenModes[soundMode]
--                 if modeCfg.audioName then audioName = modeCfg.audioName end
--                 if modeCfg.audioRef then audioRef = modeCfg.audioRef end
--                 -- no break here, allows it to take the base config and if there's another valid config after, replace it.
--             end
--         end
--     end
